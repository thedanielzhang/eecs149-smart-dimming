...
void services_init(void)
{
    ...
    our_service_init(&lighting_service);
...
void advertising_init(void)
{
    ...
    // setting manufacurer info
    ble_advdata_manuf_data_t                  manuf_data; //Variable to hold manufacturer specific data
    uint8_t data[]                            = "Light 1"; //Our data to advertise
    manuf_data.company_identifier             =  0xFFFF; //company ID for internal Development
