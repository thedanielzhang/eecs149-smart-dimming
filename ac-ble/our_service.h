...
#define BLE_UUID_BRIGHTNESS_CHARECTERISTIC          0xBEEF

// data structure for our service.
typedef struct
{
 ...
 */
uint32_t our_characteristic_update(ble_os_t *p_our_service, uint16_t light_level, uint16_t source);
